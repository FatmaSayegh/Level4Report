...
The miniaturization is implemented by giving the SVGs small spaces to occupy on
the page. As the graphics is scalable, it adopts the size of it's parent
element.  Clicking on the Graph Isomorphism icon, for example triggers the
