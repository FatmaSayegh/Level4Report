...
variable associated with the vertex is turned \emph{True}. A function does a
linear search over the vertices to find the selected vertex, the edges incident
on the vertex and also the vertices adjacent to the selected vertex. These are
...
These blue dots are connected by special lines to form the tree structure inherent
