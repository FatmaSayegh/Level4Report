...
\centering
   ...
   \centering
   \includegraphics[width=4cm]{WireframeInitial}
   \caption{}
   \label{wireframe: initial}
   \end{subfigure}\quad

   \begin{subfigure}{0.30\textwidth}
   \centering
   \includegraphics[width=4cm]{Wireframe}
   \caption{}
   \label{wireframe: final}
   \end{subfigure}
\centering
\caption{(a) An initial wireframe, (b) The final wireframe.}
\end{figure}
