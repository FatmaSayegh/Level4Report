...
In this appendix, the details of the manual system tests and their results are
tabulated.
...
\begin{tabular}{ |p{1cm}|p{2cm}|p{4cm}|p{2cm}|p{2cm}| }
 ...
 \hline
 4 
 & Title of the application is horizontally centred.
 & Title of the application is at the centre of the page on different screen sizes.
 & Title of the screen size is at horizontally centred.
 & As expected. \\
 \hline
 5 
 & Proper display of icons of graph theory topics.
 & The two rows of icons are horizontally centred and contain mini graphs
...
\begin{tabular}{ |p{1cm}|p{2cm}|p{4cm}|p{2cm}|p{2cm}| }
 ...
 & In an SPA ideally each page be independently reachable with its own unique
   URL.
 & Typing URL of the isomorphism path concatenated to the URL of the app will load the
   isomorphism page 
 & As expected. \\
 \hline
 2 
 ...
 & On the task section of the Isomorphic page being displayed, all elements of
...
\begin{tabular}{ |p{1cm}|p{2cm}|p{4cm}|p{2cm}|p{2cm}| }
 ...
 \hline
 4 
 & Next Animation buttons.
 & Pressing the next animation button from the Max 2 Cut part of the topic 
   should take the user to the Max 3 cut topic and all the elements
