...
The books and the research papers which were referred to for this project
range from theoretical texts on Graph Theory, to Programming books on the programming
language called Elm.

\subsection{Graph Theory and Algorithm Textbooks}
...
treewidth} for the explanation of the topic.
