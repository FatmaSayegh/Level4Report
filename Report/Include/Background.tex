...
Elm programming language which were helpful in this project. The paradigm of
Functional programming is usually exposited using languages such as LISP and
Haskell or Haskell like languages. Elm as a functional programming language for
the front end is relatively new under the sun and has really has the potential
to take the functional programming paradigm to a larger number of progrmmers.
...
intuitiveness makes a user interface more usable and trustable. This paper
was the inspiration for keeping the website simple with the minimum of complicated
